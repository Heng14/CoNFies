...
def main(argv):
    ...
    camera = test_cameras[len(test_cameras) // 10 * 7]
    ...
    renders_dir = exp_dir / "attributes_renders_test_zero"
    logging.info(
    ...
    while True:
        ...
        results = []
        i = 0
        for attribute_index in range(num_attributes * value_len):
            ...
            for attribute_value_index, attribute_value in enumerate(
                ...
                attribute_set = jnp.zeros((num_attributes * value_len,), dtype=jnp.float32) - 1.0
